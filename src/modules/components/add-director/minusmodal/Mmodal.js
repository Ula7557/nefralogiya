      ...
      >
        <Box  sx={{ ...style,width: 500 }}>
            ...
            >
              ...
              <InputLabel id="demo-simple-select-label">{t("input.tuz")}</InputLabel>
              <Select
                className="grow"
              ...
              >
                ...
                <FormControl fullWidth>
              <InputLabel id="demo-simple-select-label">{t("input.dezturi")}</InputLabel>
              <Select
                className="grow"
                labelId="demo-simple-select-label"
                id="demo-simple-select"
                value={dez}
                label={t("input.dezturi")}
              ...
              >
                ...
                className="grow"
                id="outlined-basic"
                label={t("input.dezmiq")}
                variant="outlined"
                type={"number"}
                inputRef={dezRef}
                    />
                <FormControl fullWidth>
              <InputLabel id="demo-simple-select-label">{t("input.konsturi")}</InputLabel>
              <Select
                className="grow"
                labelId="demo-simple-select-label"
                id="demo-simple-select"
                value={kan}
                label={t("input.konsturi")}
