...
function Name(){
    ...
    return(
        ...
        <Link to={`/more/${params.name}`}>
            <Button style={{marginTop:"24px",marginLeft:"20px",marginBottom:0,backgroundColor:"#DDEBFB",borderRadius:"12px",color:"#1464C0"}} startIcon={<ArrowBackIcon />}  variant="contained">
                Ortga
            </Button>
        </Link>
            <h2 style={{marginLeft:"20px"}}>{ "Eng so'ngi qo'shilgan vaqti :"}  {time && time.partiya.sanasi.split(" ")[0]  }</h2>
            <TableContainer style={{marginLeft:"20px",marginRight:"20px",marginTop:"24px",width:"98%"}} component={Paper}>
          <Table
            size="small"
