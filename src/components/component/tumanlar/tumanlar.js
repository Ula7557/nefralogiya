    ...
    return (
      <>
        <div className="tumanlar">
          <h1 className="tuman-head">Muassasalar</h1>
          ...
          <>
            ...
            <TableContainer component={Paper}>
              <Table className={classes.table} aria-label="customized table">
                <TableHead>
                  <TableRow>
                    <TableCell bold>Muassasa</TableCell>
                    <TableCell align="right" bold>Bemorlar</TableCell>
                    <TableCell align="right" bold>Shifokorlar</TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                  {
