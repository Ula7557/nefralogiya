import { Button, FormControl, InputLabel, MenuItem, Paper, Select, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TextareaAutosize, TextField } from '@mui/material';
 ...
 const [name, setName] = useState("");
  ...
  const classes = {
   ...
   console.log(person,"PRES");
    ...
    // console.log(down);
    console.log('person?.mahsulotlar', arr.find(el => el.name === per ));
        ...
        <div className="sarflov_inner">
          ...
          <div className="sarflov_inner_right">
            <Button
              ...
              style={{ backgroundColor: "#E63943", color: "#fff" }}
        ...
        <PDFExport ref={pdfExportComponent}>
          ...
          <div div className="sarflov_block sarflov_block_m">
            <h4 className="sarflov_block_title">
              {person.ariza_turi === "sarflov" ? "Vositalar" : "Jihozlar"}
            </h4>
