import {Alert, Button, Checkbox, Fade, FormControl, FormControlLabel, FormGroup, FormLabel, InputLabel, MenuItem, Modal, Paper, Select, Snackbar, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TextField } from "@mui/material";
  ...
  return (
    ...
    >
      <div className="sklad_top">
        {id && (
          <>
            <h3 className="jihozlar_title">{t("jihoz.j1")}</h3>
            <Button
            style={{
...
<div className="arxiv_filter">
          <FormControl component="fieldset">
            <FormLabel component="legend">{t("jihoz.j3")}</FormLabel>
      ...
      <div className="jihozlar">
        ...
        >
           <div className="jihozlar_block_top_inner">
            <h5 className="jihozlar_text">{t("bildirishnoma.soni")}</h5>
          </div>
          <div className="jihozlar_block_top_inner">
            <h5 className="jihozlar_text">{t("jihoz.gemo")}</h5>
          </div>
          <div className="jihozlar_block_top_inner">
          ...
          <div className="jihozlar_block_top_inner">
            <h5 className="jihozlar_text">{t("jihoz.yil")}</h5>
          </div>
          <div className="jihozlar_block_top_inner">
            <h5 className="jihozlar_text">{t("jihoz.yil2")}</h5>
          </div>
          <div className="jihozlar_block_top_inner">
            <h5 className="jihozlar_text">
            {t("jihoz.eks")}
          ...
          {id && (
            <div className="jihozlar_block_top_inner">
              <h5 className="jihozlar_text">{t("jihoz.mal")}</h5>
            </div>
          )}
        </div>
      </div>
          ...
          return (
            <>
              ...
              <div className="jihozlar_block_top_inner_text">
                ...
                <div div className="jihozlar_block_top_inner_text">
                  <p className="jihozlar_text">{item.seriya_raqami}</p>
                </div>
                {id && (
                  <div
                    div
                ...
                <form style={{
                  ...
                  <div className="input_block">
                    ...
                    <div className="input_div">
                      <TextField
                        id="outlined-basic"
                        label={t("jihoz.ishlab") +" "+`(${t("jihoz.soat")})`}
                        variant="outlined"
                  ...
                  <div className="input_block">
                    ...
                    <div className="input_div">
                      <TextField
                        id="outlined-basic"
                        label={t("jihoz.eks") +" "+`(${t("jihoz.soat")})`}
                        variant="outlined"
                        name="ishlash_vaqti"
                        type="number"
                        onChange={onChange}
