...
import Bemormodal from "./bemormodal/bemormodal";
const SingleBemor = () => {
  ...
  console.log('excelbemor', excelbemor);
  ...
  useEffect(() =>{ 
    ...
    request
      .post(`seans/bemor/`, formsdata)
      .then(data => setDial(data.data.data))
  },[])
      ...
      <div className="singlebemor_top">
        ...
        <div className="singlebemor_top_right">
          <Button startIcon={<DescriptionIcon />} variant="contained">
            <CSVLink data={JSON.stringify(person)}  className="excel_download">{t("bola.excel")}</CSVLink>
          </Button>
        </div>
      </div>
        ...
        <div className="singlebemor_block_left">
          <div className="singlebemor_block_info">
            ...
            <div className="singlebemor_block_info_inner">
              ...
              <h5 className="singlebemor_block_info_desc">
                 {
                  person.nogironligi == 4 ? 'Nogiron emas' : `${person.nogironligi}-guruh`
                }
              </h5>
            </div>
            <div className="singlebemor_block_info_inner">
          ...
          <div className="singlebemor_block_info">
            ...
            <div className="singlebemor_block_info_inner">
              ...
              <h5 className="singlebemor_block_info_desc">
                {person.bemor_holati == 2
                        ? t("sbola.h4")
                        : person.bemor_holati == 1
                        ? t("sbola.h3")
                        : person.bemor_holati == 3
                        ? t("sbola.h5")
                        : t("sbola.l5")}
              </h5>
            </div>
          ...
          <div className="singlebemor_block_info">
            ...
            <div className="singlebemor_block_info_inner">
              <h5 className="singlebemor_block_info_desc">{t("shifokor.tel")}</h5>
              <h5 className="singlebemor_block_info_desc">
                {person.tel_raqami}
              </h5>
            </div>
            ...
            <div className="singlebemor_block_info_inner">
              <h5 className="singlebemor_block_info_desc">{t("sbola.b5")}</h5>
              <h5 className="singlebemor_block_info_desc">
                {person.manzil}
              </h5>
            </div>
            ...
            <div className="singlebemor_block_info_inner">
              ...
              <h5 className="singlebemor_block_info_desc">
                <a
                  ...
                  href={`https://admin-nefro.ssv.uz/${person.bemor_passporti}`}
                >
                  {t("sbola.p4")}
                </a>
              </h5>
            ...
            <div className="singlebemor_block_info_inner">
              ...
              <h5 className="singlebemor_block_info_desc">
                <a
                  className="pasport_file"
                  download target='_blank'
                  href={`https://admin-nefro.ssv.uz/${person.qoshimcha_malumot}`}
                >
                  {t("sbola.p4")}
                </a>
              </h5>
        ...
        <div className="singlebemor_block_right">
          <div className="singlebemor_block_info">
            ...
            <div className="singlebemor_block_info_inner">
              ...
              <h5 style={{overflowY:"scroll"}} className="singlebemor_block_info_desc">
                {person.muassasa && person.muassasa.nomi}
              </h5>
            </div>
            {/* <div className="singlebemor_block_info_inner">
              <h5 className="singlebemor_block_info_desc">
          ...
          <div className="singlebemor_block_info">
            ...
            <div className="singlebemor_block_info_inner">
              ...
              <h5 className="singlebemor_block_info_desc">
                {dial && person.dializ_olgan_miqdori +  dial.length}
              </h5>
            </div>
            <div className="singlebemor_block_info_inner">
              <h5 className="singlebemor_block_info_desc">{t("sbola.f")}</h5>
              <h5 className="singlebemor_block_info_desc">{person.filtr}</h5>
            </div>
            <div className="singlebemor_block_info_inner">
              <h5 className="singlebemor_block_info_desc">{t("sbola.m")}</h5>
              <h5 className="singlebemor_block_info_desc">{person.magistral}</h5>
            </div>
            <div className="singlebemor_block_info_inner">
              <h5 className="singlebemor_block_info_desc">{t("sbola.i1")}</h5>
              <h5 className="singlebemor_block_info_desc">{person.igna2}</h5>
            </div>
            <div className="singlebemor_block_info_inner">
              <h5 className="singlebemor_block_info_desc">{t("sbola.i2")}</h5>
              <h5 className="singlebemor_block_info_desc">{person.igna}</h5>
            </div>
            <div className="singlebemor_block_info_inner">
